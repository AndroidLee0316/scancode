...
import com.pasc.lib.zxing.pdf417.PDF417Common;
import com.pasc.lib.zxing.pdf417.decoder.ec.ErrorCorrection;
import com.pasc.lib.zxing.ResultPoint;
...
public final class PDF417ScanningDecoder {
  ...
  private static Codeword detectCodeword(BitMatrix image,
    ...
    if (!checkCodewordSkew(codewordBitCount, minCodewordWidth, maxCodewordWidth)) {
      ...
      // create the bit count from it and normalize it to 8. This would zxing_help with single pixel errors.
      return null;
    }
