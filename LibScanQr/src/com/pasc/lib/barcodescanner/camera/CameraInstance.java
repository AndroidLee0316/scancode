...
import com.pasc.lib.barcodescanner.Util;
...
public class CameraInstance {
        ...
        public void run() {
            try {
                ...
                if (readyHandler != null) {
                    readyHandler.obtainMessage(R.id.zxing_id_prewiew_size_ready, getPreviewSize()).sendToTarget();
                }
            } catch (Exception e) {
                notifyError(e);
    ...
    private void notifyError(Exception error) {
        if (readyHandler != null) {
            readyHandler.obtainMessage(R.id.zxing_id_camera_error, error).sendToTarget();
        }
    }
