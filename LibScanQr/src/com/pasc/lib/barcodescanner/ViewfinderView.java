...
public class ViewfinderView extends View {
    ...
    protected com.pasc.lib.barcodescanner.CameraPreview cameraPreview;
    ...
    public void setCameraPreview(com.pasc.lib.barcodescanner.CameraPreview view) {
        this.cameraPreview = view;
        view.addStateListener(new com.pasc.lib.barcodescanner.CameraPreview.StateListener() {
            @Override
